...
-e <int> Blast E-value Cutoff. [default: 1e-3]
-c <int> NUMT Coverage Cutoff. [default: 70]
-a <int> Minimum Support for calling NUMTs from Supplementary Alignments. [default: 5]
